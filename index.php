...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="BkTable/rtbs/index.php">Reserve Table <span class="sr-only"></span></a> </li>                            <li class="nav-item"> <a class="nav-link active" href="reseversion/index.php">Facilities <span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/new.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Reserve Table OR Order Delivery </h1>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Today Offer</h2>
                    <p class="lead">Reserve a table & Enjoy the offer with your love...</p>
                </div>
                <div class="row">
						<?php 					
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We have menus from several delivery categories, so you're covered.</p>
                                </div>
                            </div>
                        </div>
